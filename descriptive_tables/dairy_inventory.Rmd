...
gpf_ppt[,c(273:276)] <- lapply(gpf_ppt[,c(273:276)], as.numeric)
...
## 8. Daily household production of cows in liters, by district, by breed
...
library(ggplot2)
ggplot(productivity1, aes(round, median, fill = household_type)) +
...
ggplot(productivity2, aes(round, median)) +
